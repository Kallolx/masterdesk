      ...
      <div className="flex items-center space-x-4">
        {!isLoggedIn ? (
          <>
            <button
              onClick={handleLogin}
              className="hidden md:inline-block px-5 py-2 rounded-lg border border-gray-300 text-gray-700 text-lg font-bold hover:bg-gray-50 transition-colors"
            >
              Login
            </button>
              ...
              {!isLoggedIn ? (
                <div className="flex space-x-3 pt-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 rounded-lg border border-gray-300 text-gray-700 font-bold"
                  >
                    Login
                  </button>
                  <button
